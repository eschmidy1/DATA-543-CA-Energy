...
To view and run our code, either the Jupyter Notebook File ________.ipynb or the Python file ___________.py can be run after cloning this repository. Non-standard required python packages include pyTorch, Scikit-Learn, and xgboost. 

After running, these files will produce full model comparisons and the visuals contained within our final presentation. Project sources can be found below: 
